...
<!-- Mirrored from designreset.com/cork/ltr/demo4/auth_register_boxed.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 17 May 2021 16:05:16 GMT -->
			...
			<div class="form-form-wrap">
				<div class="form-container">
					<div class="form-content">
						...
						<h1 class="">Register Apoteker</h1>
						<p class="signup-link register">Sudah mempunyai akun? <a href="<?= base_url('apotek/auth') ?>">Log in</a></p>
						<form class="text-left" action="<?= base_url('apotek/auth/proses_registrasi') ?>" method="POST">
							<div class="form">
								...
								<div id="username-field" class="field-wrapper input">
									...
									<input name="nama_admin" type="text" class="form-control" placeholder="Nama Admin" value="<?php echo set_value('nama_admin') ?>">
									<span class="form-text text-danger"><?= form_error('nama_admin') ?></span>
								</div>
