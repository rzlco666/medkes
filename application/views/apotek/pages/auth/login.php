			...
			<div class="form-form-wrap">
				<div class="form-container">
					<div class="form-content">
						...
						<h1 class="">Log In Apoteker</h1>
						<p class="">Log in menggunakan akun Apoteker untuk melanjutkan.</p>

						<form class="text-left" action="<?= base_url('apotek/auth/proses_login') ?>" method="POST">
							<div class="form">
								...
								<p class="signup-link">Belum mempunyai akun ? <a href="<?= base_url('apotek/auth/registrasi') ?>">Buat akun sekarang</a></p>
