...
<head>
	<meta charset="utf-8" />
	<title>Log In | Admin MEDKES</title>
				...
				<div class="col-md-8 col-lg-6 col-xl-4">
					<div class="card bg-pattern">
						...
						<div class="card-body p-4">
							...
							<div class="text-center w-75 m-auto">
								...
								<p class="text-muted mb-4 mt-3">Masukkan username dan password untuk masuk ke admin panel.</p>
							</div>
					...
					<div class="row mt-3">
						<div class="col-12 text-center">
							<p class="text-white-50">Belum Terdaftar? <a href="<?= base_url('admin/auth/registrasi') ?>" class="text-white ms-1"><b>Buat akun disini!</b></a></p>
						</div> <!-- end col -->
					</div>
					<!-- end row -->
