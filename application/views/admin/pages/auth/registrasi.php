...
<head>
	<meta charset="utf-8" />
	<title>Register | Admin MEDKES</title>
				...
				<div class="col-md-8 col-lg-6 col-xl-4">
					<div class="card bg-pattern">
						...
						<div class="card-body p-4">
							...
							<form action="<?= base_url('admin/auth/proses_registrasi') ?>" method="POST">

								<div class="mb-3">
									<label for="nama_admin" class="form-label">Nama</label>
									<input class="form-control" type="text" id="nama_admin" name="nama_admin" required="" placeholder="Enter your nama">
					...
					<div class="row mt-3">
						<div class="col-12 text-center">
							<p class="text-white-50">Sudah Terdaftar? <a href="<?= base_url('admin/auth/') ?>" class="text-white ms-1"><b>login disini!</b></a></p>
						</div> <!-- end col -->
					</div>
					<!-- end row -->
