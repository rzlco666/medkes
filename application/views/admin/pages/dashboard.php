                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="inbox-widget" data-simplebar style="max-height: 407px;">
                                            <div class="inbox-item">
                                                <div class="inbox-item-img"><img src="<?= base_url('assets_admin/') ?>/images/users/user-2.jpg" class="rounded-circle" alt=""></div>
                                            ...
                                            <div class="inbox-item">
                                                <div class="inbox-item-img"><img src="<?= base_url('assets_admin/') ?>/images/users/user-3.jpg" class="rounded-circle" alt=""></div>
                                            ...
                                            <div class="inbox-item">
                                                <div class="inbox-item-img"><img src="<?= base_url('assets_admin/') ?>/images/users/user-4.jpg" class="rounded-circle" alt=""></div>
                                            ...
                                            <div class="inbox-item">
                                                <div class="inbox-item-img"><img src="<?= base_url('assets_admin/') ?>/images/users/user-5.jpg" class="rounded-circle" alt=""></div>
                                            ...
                                            <div class="inbox-item">
                                                <div class="inbox-item-img"><img src="<?= base_url('assets_admin/') ?>/images/users/user-6.jpg" class="rounded-circle" alt=""></div>
                                                ...
                                                <ul class="conversation-list">
                                                    <li class="clearfix">
                                                        <div class="chat-avatar">
                                                            <img src="<?= base_url('assets_admin/') ?>/images/users/user-5.jpg" alt="male">
                                                            <i>10:00</i>
                                                        </div>
                                                    ...
                                                    <li class="clearfix odd">
                                                        <div class="chat-avatar">
                                                            <img src="<?= base_url('assets_admin/') ?>/images/users/user-1.jpg" alt="Female">
                                                            <i>10:01</i>
                                                        </div>
                                                        <div class="conversation-text">
                                                            <div class="ctext-wrap">
                                                    ...
                                                    <li class="clearfix odd">
                                                        <div class="chat-avatar">
                                                            <img src="<?= base_url('assets_admin/') ?>/images/users/user-1.jpg" alt="male">
                                                            <i>10:02</i>
                                                        </div>
                                                        <div class="conversation-text">
                                                            <div class="ctext-wrap">
