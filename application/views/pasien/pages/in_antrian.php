															...
															<div class="row">
																...
																<div class="col-sm-6 text-sm-right">
																	<p class="inv-list-number">
																		<span class="inv-title">No Antrian : </span>
																		<span class="inv-number">#<?= $invoice->id_antrian ?></span>
																	</p>
																</div>
																...
																<div class="col-sm-6 align-self-center mt-3 text-sm-right">
																	<p class="inv-created-date">
																		<span class="inv-title">Poli :
																		</span>
																		<span class="inv-date"><?= $invoice->nama_poli ?></span>
																	</p>
																	<p class="inv-created-date">
																		<span class="inv-title">Untuk Tanggal :
																		</span>
														...
														<div class="inv--detail-section inv--customer-detail-section">
															<div class="row">
																<div class="col-xl-8 col-lg-7 col-md-6 col-sm-4 align-self-center">
																	<p class="inv-to">No Antrian</p>
																</div>

																<div class="col-xl-8 col-lg-7 col-md-6 col-sm-4">
																	<h3>#<?= $invoice->id_antrian ?></h3>
																</div>
														...
														<div class="inv--product-table-section">
															<div class="table-responsive">
																<table class="table">
																	...
																	<tbody>
																		<tr>
																			<td><b><?= $invoice->id_antrian ?></b></td>
																			<td><?= $invoice->nama_poli ?></td>
																			<td class="text-right"><?= longdate_indo($invoice->tanggal) ?></td>
																		</tr>
																	</tbody>
																</table>
															</div>
																	...
																	<div class="text-sm-right">
																		<div class="row">
																			<div class="col-sm-8 col-7 grand-total-title">
																				<h4 class="">Status Antrian :</h4>
																			</div>
																			<div class="col-sm-4 col-5 grand-total-amount">
																				<h4 class=""><span class="text-success"><b>Valid</b></span></h4>
																			</div>
																		</div>
																	</div>
																</div>
