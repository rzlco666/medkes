...
<head>
	...
	<link href="<?= base_url('assets/admin/') ?>plugins/perfect-scrollbar/perfect-scrollbar.css" rel="stylesheet"
		  type="text/css"/>
												...
												<div class="content-section">
														...
														<div class="row">
															<div class="col-sm-2 mr-auto">
																<div class="d-flex">
																	<img style="width: 100px;"
																		 src="<?= base_url('assets_pasien/') ?>images/logo/resep.png"
																		 alt="company"/>
																</div>
															</div>
															...
															<div class="col-sm-8" style="text-align: center">
																...
																<p class="inv-email-address">
																	Jl. Raya Lorok, Dsn. Kutukan, Ds. Cokrokembang, Kec.
																	Ngadirojo, Kab. Pacitan, Prov. Jawa Timur
																</p>
																<p class="inv-email-address">
																	Generated via Media Kesehatan | helpmedkes@gmail.com
																	| 0812 3456 7891
																</p>
															</div>
															...
															<div class="col-sm-2 ml-auto">
																<div class="d-flex">
																	<img
																		 src="<?= base_url('assets_pasien/') ?>images/logo/logo_medkes2.png"
																		 alt="company"/>
																</div>
															</div>
														</div>
													...
													<div class="inv--product-table-section">
														<p style="text-align: right; margin-right: 20px;">
															Ngadirojo, <?= date_indo($resepp->tanggal) ?></p>
														<p style="text-align: right; margin-right: 20px;">
															No Resep : <?= $resepp->id_resep ?></p>
														<p style="text-align: left; margin-left: 20px;">Dokter
															: <?= $resepp->nama_dokter ?></p>
														<p style="text-align: left; margin-left: 20px;">Hasil Diagnosa
															: <?= $resepp->diagnosa ?></p><br>
														<p style="text-align: left; margin-left: 20px;">Nama Pasien
															: <?= $resepp->nama_pasien ?></p>
														<p style="text-align: left; margin-left: 20px;">Umur
															: <?= date_diff(date_create($resepp->tgl_lahir), date_create('now'))->y; ?> Tahun</p>
														<p style="text-align: left; margin-left: 20px;">Jenis Kelamin
															: <?= $resepp->pasjnskel ?></p>
														<p style="text-align: left; margin-left: 20px;">Alamat
															: <?= $resepp->pasalm ?></p>
																...
																<div class="text-sm-right">
																	<div class="row">
																		<div class="col-12 grand-total-title">
																			<p>Dicetak
																				pada <?= longdate_indo(date("Y-m-d")) . ' ' . date("h:i:s") ?> </p>
																		</div>
																	</div>
																</div>
															</div>
