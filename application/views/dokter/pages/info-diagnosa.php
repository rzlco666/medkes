		...
		<div class="container-fluid">
					...
					<div class="page-title-box">
						<div class="page-title-right">
							<ol class="breadcrumb m-0">
								...
								<li class="breadcrumb-item active">Info Diagnosa</li>
							</ol>
						</div>
						<h4 class="page-title">Info Diagnosa - <?= $id_konsultasi ?></h4>
					</div>
				</div>
			</div>
			<!-- end page title -->
			...
			<div class="row">
				<div class="col-12">
					<div class="card">
						<div class="card-body">
							<h4 class="header-title">Info Diagnosa - <?= $id_konsultasi ?></h4>

							<form class="contact">
								<div class="row mt-3">
									<div class="col-md-6 mb-3">
										<label class="form-label">No Rekam Medis</label>
										<input type="text" disabled name="no_rekam_medis" class="form-control"
									...
									<div class="col-md-3 mb-3">
										...
										<input id="myDate" disabled name="tanggal" class="form-control text-black"
									...
									<div class="col-md-3 mb-3">
										...
										<input id="myID" disabled data-enable-time="true" name="jam"
											   class="form-control active text-black" type="text"
											   placeholder="Pilih Jam.." value="<?= $diagnosa->jam ?>">
								...
								<div class="row">
									<div class="mb-3 col-md-6">
										...
										<textarea disabled name="diagnosa" class="form-control mb-4" cols="30"
				...
				<div class="col-12">
					<div class="card">
						<div class="card-body">
							...
							<h4 class="header-title mb-2">Data Resep Obat</h4>
